...
public class UserTester {
    ...
    public void test(int rankOfActivity, int expectedRank, int expectedProgress) throws Exception {
    ...
    @Test
    public void testVariousRankUpActivity() throws Exception {
        setUp();
    ...
    @Test
    public void testRankUpActivity() throws Exception {
        setUp();
        test(1, -2, 40);
        test(1, -2, 80);
        test(1, -1, 20);
